...
| Document | What It Is |
|---|---|
| [DEMO_GUIDE.md](DEMO_GUIDE.md) | **Start here.** How to run all 3 demo scripts, what each shows, what judges see. |
| [ARCHITECTURE.md](ARCHITECTURE.md) | System architecture — 12 Mermaid diagrams covering the full ERC-7579 → CRE → Uniswap flow |
| [CONFIDENTIAL_HTTP.md](CONFIDENTIAL_HTTP.md) | Privacy track deep-dive — how `ConfidentialHTTPClient` protects all API keys and contract source |
| [LESSONS_LEARNED.md](LESSONS_LEARNED.md) | Engineering ledger — every bug, root cause, and fix across all phases |
...
To enable the authenticated tier:
```bash
