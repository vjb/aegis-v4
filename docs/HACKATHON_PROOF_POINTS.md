...
| Session key autonomy | Agent submits `requestAudit()` UserOp using ONLY an ERC-7715 session key — owner key not used | [on-chain tx](https://sepolia.basescan.org/tx/0xe1cae6043ad913f0d949b4551239c3b1de18f959c71fd107b1605256a2d1398d) |
