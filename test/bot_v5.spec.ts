...
// ── V4 vs V5 calldata shape comparison ────────────────────────────────────
describe("V4 vs V5 call structure", () => {
    it("V5 triggerSwap has 3 params, V4 'bot.ts' ABI had only 2 (bug fixed)", () => {
        // V4 bot.ts had triggerSwap with only _token + _amount (missing _amountOutMinimum)
